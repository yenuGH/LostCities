...
public class PlayerScore {
    ...
    public void calculateScore() {
        ...
        if ((numberOfPointCards + numberOfWagers) >= 8) {
            score += 20;
        }
    ...
    public int getNumberOfPointCards() {
        return numberOfPointCards;
    }
